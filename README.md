# Glosario Técnico: OSINT Deck

Este documento reúne las definiciones clave para la comprensión del proyecto **OSINT Deck**, abarcando desde conceptos fundamentales de ciberseguridad hasta la infraestructura específica del desarrollo.

## Tabla de Contenidos

1. [Conceptos OSINT y Ciberseguridad](#1-conceptos-osint-y-ciberseguridad)
2. [Tecnologías Utilizadas](#2-tecnologías-utilizadas)
3. [Infraestructura OSINT Deck](#3-infraestructura-osint-deck)
4. [Metodología y Enfoque Académico](#4-metodología-y-enfoque-académico)
5. [Documentación del TFI](#5-documentación-del-tfi)
6. [Perfiles de Usuario](#6-perfiles-de-usuario)

---

## 1. <span style="color: #3b82f6;">Conceptos OSINT y Ciberseguridad</span>

| Término | Definición |
| :--- | :--- |
| **OSINT (Open Source Intelligence)** | Inteligencia de Fuentes Abiertas. Conjunto de técnicas y herramientas para recopilar, analizar y correlacionar información pública disponible en Internet con fines de investigación e inteligencia. |
| **Inteligencia de Fuentes Abiertas** | Traducción al español de OSINT. Disciplina que utiliza datos de acceso público (redes sociales, foros, registros públicos) para generar conocimiento útil. |
...
| **Correlación de datos** | Técnica que consiste en conectar diferentes fragmentos de información (como un correo, una IP y un nombre de usuario) para encontrar relaciones y patrones no evidentes por separado. |
...
| **Spearphishing** | Variante de phishing altamente dirigida y personalizada, donde el atacante investiga a la víctima previamente para hacer el engaño más creíble. |
...
| **Detección automática** | Capacidad del sistema para identificar por sí mismo qué tipo de dato ha ingresado el usuario (ej. saber si es un email o una IP) sin necesidad de selección manual. |
...
## 2. <span style="color: #3b82f6;">Tecnologías Utilizadas</span>
...
| **Nonces** | "Números usados una sola vez". Tokens de seguridad que protegen las acciones en WordPress contra ataques de falsificación de solicitudes (CSRF). |
...
| **Apache** | Servidor web de código abierto, robusto y utilizado, encargado de entregar las páginas web a los usuarios. |
...
| **Composer** | Gestor de dependencias para PHP (mencionado en el proyecto como una alternativa evaluada pero descartada). |
...
## 3. <span style="color: #3b82f6;">Infraestructura OSINT Deck</span>

| Término | Definición |
| :--- | :--- |
| **Decks** | "Mazos" o grupos de herramientas organizadas. Metáfora central del proyecto para agrupar utilidades según su propósito. |
...
| **Frontend** | Parte del sitio web que ven los visitantes. Es la "cara" del sistema donde se realizan las búsquedas y se ven los resultados. |
| **Backend** | Parte "trasera" del sistema que no ve el usuario. Es donde ocurre la lógica, el procesamiento de datos y la conexión con la base de datos. |
...
## 4. <span style="color: #3b82f6;">Metodología y Enfoque Académico</span>
...
## 5. <span style="color: #3b82f6;">Documentación del TFI</span>
...
## 6. <span style="color: #3b82f6;">Perfiles de Usuario</span>
